 ...
 */
public class Level5 extends AbstractLevel implements Level {

    protected BonbonellaGameController controller;
    private Realm1 realm;

    public Level5(World world, BonbonellaGameController controller) {
    ...
    public Level getNextLevel(World world) {
        return new Level6(world, controller);
    }
