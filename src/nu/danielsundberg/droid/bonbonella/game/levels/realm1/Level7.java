 ...
 */
public class Level7 extends AbstractLevel implements Level {

    protected BonbonellaGameController controller;
    private Realm1 realm;

    public Level7(World world, BonbonellaGameController controller) {
    ...
    public Level getNextLevel(World world) {
        return new Level8(world, controller);
    }
